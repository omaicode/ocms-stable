 ...
 *
 * @deprecated Renamed to \OCMS\Debugbar\Facades\Debugbar
 * @see \OCMS\Debugbar\Facades\Debugbar
 *
 * @see \OCMS\Debugbar\LaravelDebugbar
 */
class Facade extends \OCMS\Debugbar\Facades\Debugbar
{
}
