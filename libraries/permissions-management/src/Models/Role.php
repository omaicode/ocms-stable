...
namespace OCMS\Permission\Models;

use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\Relations\BelongsToMany;
use OCMS\Permission\Contracts\Role as RoleContract;
use OCMS\Permission\Exceptions\GuardDoesNotMatch;
use OCMS\Permission\Exceptions\RoleAlreadyExists;
use OCMS\Permission\Exceptions\RoleDoesNotExist;
use OCMS\Permission\Guard;
use OCMS\Permission\PermissionRegistrar;
use OCMS\Permission\Traits\HasPermissions;
use OCMS\Permission\Traits\RefreshesPermissionCache;
...
class Role extends Model implements RoleContract
{
     ...
     *
     * @return \OCMS\Permission\Contracts\Role|\OCMS\Permission\Models\Role
     *
