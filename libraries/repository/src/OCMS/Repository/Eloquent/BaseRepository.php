...
namespace OCMS\Repository\Eloquent;
...
use OCMS\Repository\Contracts\CriteriaInterface;
use OCMS\Repository\Contracts\Presentable;
use OCMS\Repository\Contracts\PresenterInterface;
use OCMS\Repository\Contracts\RepositoryCriteriaInterface;
use OCMS\Repository\Contracts\RepositoryInterface;
use OCMS\Repository\Events\RepositoryEntityCreated;
use OCMS\Repository\Events\RepositoryEntityCreating;
use OCMS\Repository\Events\RepositoryEntityDeleted;
use OCMS\Repository\Events\RepositoryEntityDeleting;
use OCMS\Repository\Events\RepositoryEntityUpdated;
use OCMS\Repository\Events\RepositoryEntityUpdating;
use OCMS\Repository\Exceptions\RepositoryException;
use OCMS\Repository\Traits\ComparesVersionsTrait;
use OCMS\Validator\Contracts\ValidatorInterface;
use OCMS\Validator\Exceptions\ValidatorException;

/**
 * Class BaseRepository
 *
 * @package OCMS\Repository\Eloquent
...
abstract class BaseRepository implements RepositoryInterface, RepositoryCriteriaInterface
{
    ...
    /**
     * Specify Validator class name of OCMS\Validator\Contracts\ValidatorInterface
     *
     * @return null
     * @throws Exception
     */
    public function validator()
    {
        if (isset($this->rules) && !is_null($this->rules) && is_array($this->rules) && !empty($this->rules)) {
            if (class_exists('OCMS\Validator\LaravelValidator')) {
                $validator = app('OCMS\Validator\LaravelValidator');
    ...
    public function makePresenter($presenter = null)
    {
        ...
        if (!is_null($presenter)) {
            ...
            if (!$this->presenter instanceof PresenterInterface) {
                throw new RepositoryException("Class {$presenter} must be an instance of OCMS\\Repository\\Contracts\\PresenterInterface");
            }
    ...
    public function makeValidator($validator = null)
    {
        ...
        if (!is_null($validator)) {
            ...
            if (!$this->validator instanceof ValidatorInterface) {
                throw new RepositoryException("Class {$validator} must be an instance of OCMS\\Validator\\Contracts\\ValidatorInterface");
            }
     ...
     *
     * @return $this
     * @throws \OCMS\Repository\Exceptions\RepositoryException
     */
    public function pushCriteria($criteria)
    {
        ...
        if (!$criteria instanceof CriteriaInterface) {
            throw new RepositoryException("Class " . get_class($criteria) . " must be an instance of OCMS\\Repository\\Contracts\\CriteriaInterface");
        }
