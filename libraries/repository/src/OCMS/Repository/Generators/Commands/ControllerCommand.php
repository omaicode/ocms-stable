...
use OCMS\Repository\Generators\ControllerGenerator;
...
class ControllerCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'repository:resource';
    ...
    {
        $this->name = ((float) app()->version() >= 5.5  ? 'repository:rest-controller' : 'repository:resource');
        parent::__construct();
    }
