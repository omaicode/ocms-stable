...
namespace OCMS\Socialite;

use Illuminate\Support\Arr;
use Illuminate\Support\Manager;
use Illuminate\Support\Str;
use InvalidArgumentException;
use OCMS\Socialite\One\TwitterProvider;
use OCMS\Socialite\Two\BitbucketProvider;
use OCMS\Socialite\Two\FacebookProvider;
use OCMS\Socialite\Two\GithubProvider;
use OCMS\Socialite\Two\GitlabProvider;
use OCMS\Socialite\Two\GoogleProvider;
use OCMS\Socialite\Two\LinkedInOpenIdProvider;
use OCMS\Socialite\Two\LinkedInProvider;
use OCMS\Socialite\Two\NaverProvider;
use OCMS\Socialite\Two\SlackProvider;
use OCMS\Socialite\Two\TwitterProvider as TwitterOAuth2Provider;
use League\OAuth1\Client\Server\Twitter as TwitterServer;
use OCMS\Socialite\Two\KakaoProvider;
...
class SocialiteManager extends Manager implements Contracts\Factory
{
     ...
     *
     * @return \OCMS\Socialite\Two\AbstractProvider
     */
     ...
     * Create an instance of the specified driver.
     *
     * @return \OCMS\Socialite\One\AbstractProvider|\OCMS\Socialite\Two\AbstractProvider
     */
    ...
    {
        $config = $this->config->get('services.kakao');
     ...
     * @return \OCMS\Socialite\Two\AbstractProvider
     */
    protected function createNaverDriver()
    {
        $config = $this->config->get('services.naver');
