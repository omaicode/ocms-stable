...
Array.from(document.querySelectorAll('button[data-bs-toggle="custom-modal"]')).forEach( (e) => {
    e.addEventListener('click', function(element) {
      element.preventDefault();
      if (e.hasAttribute('data-bs-target')) {
        showModal(e.getAttribute('data-bs-target').substring(1));
      }
    }); 
});
...
w.addEventListener('load', function() {
    ...
    forms.forEach(function(form) {
        form.addEventListener('submit', () => {
            ...
            if(form.getAttribute('no-loading') !== 'true' && submitBtns && submitBtns.length > 0) {
